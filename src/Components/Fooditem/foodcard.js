        ...
        <>
            <div className="food-item-section-container">
                ...
                <div className="food-item-section-categories">
                    {["all", "burger", "pizza", "pasta", "sushi", "salad", "dessert", "drinks"].map((category) => (
                        <button
                            key={category}
                        ...
                        <div key={item.id} className="food-item-section-card" data-id={item.id}>
                            ...
                            <div className="food-item-section-content">
                                ...
                                <div className="food-item-section-footer">
                                    ...
                                    <button className="food-item-section-add-btn" onClick={() => addToCart(item)}>
            ...
            {/* Toast  */}
            <div className={`food-item-section-toast ${toast.show ? "food-item-section-show" : ""}`}>{toast.message}</div>
        </>
    )
}
